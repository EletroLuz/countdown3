...
function menu_renderer.render_menu(plugin_enabled, doorsEnabled, loopEnabled, revive_enabled, profane_mindcage_enabled, profane_mindcage_count, moveThreshold)
    if menu.main_tree:push("HellChest Farmer (EletroLuz)-V1.5") then
        safe_render(menu.plugin_enabled, "Enable Movement Plugin", "Enable or disable the movement plugin", plugin_enabled)
